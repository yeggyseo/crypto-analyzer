...
app.get("/test", (req, res) => {
  ...
  axios.get('https://api.stocktwits.com/api/2/trending/symbols.json').then(res => {
    ...
    async function getTweets() {
      ...
      for (let i = 0; i < cryptos.length; i++) {
        ...
        response = await axios.get(`https://api.stocktwits.com/api/2/streams/symbol/${symbol}.json`).then(res => {
